...
- 27ea931: Fix drag handle ghost image alignment when dragging blocks inside offset layouts, and preserve correct ghost image behavior for RTL content.
...
- 27ea931: Fix dependencies installation after packages updates producing peer dependency resolution conflicts
- 27ea931: Fix text selection collapsing after toggling off a list with AllSelection
- Updated dependencies [27ea931]
  - @tiptap/pm@3.22.4
...
- 27ea931: Fix dependencies installation after packages updates producing peer dependency resolution conflicts
- 27ea931: Treat non-indented continuation lines following an ordered list marker as part of the same list item.
